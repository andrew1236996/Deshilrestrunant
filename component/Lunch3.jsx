...
const Lunch3 = () => {
  return (
    <section className="  mt-[30%] w-full min-h-screen flex flex-col lg:flex-row justify-between items-center max-w-4xl mx-auto px-4 sm:px-6 py-16 gap-12 z-10 bg-white">
      ...
      <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
        ...
        {/* Button */}
        <div className="mt-4">
          <Link to="/Book" className="px-6 py-2 border border-black font-semibold text-sm hover:bg-black hover:text-white transition duration-300">
            Book A Table
          </Link>
        </div>
      </div>
