...
const Dinner9 = () => {
  return (
    <>
      {/* Heading */}
      <div className="mx-auto text-center pt-10 px-4   py-16 bg-black h-full">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-6  px-4 bg-black h-full">
        {/* Card 1 */}
