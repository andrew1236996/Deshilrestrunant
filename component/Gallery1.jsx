...
import bgImage from '../src/assets/images/engin-akyurt-v6z8FoqPbJ8-unsplash.jpg'; 
import { Link } from 'react-router-dom';// ✅ Update path to your actual image
    ...
    >
      ...
      <div className="relative top-40 mx-auto text-center space-y-4 px-4 z-10 text-white">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center items-center space-x-3 text-sm font-semibold">
          ...
          <Link to="/FoodMenu" className="hover:text-red-500">/ABOUT US</Link>
        </div>
      </div>
    </div>
  );
